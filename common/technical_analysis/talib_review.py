...
class TechnicalAnalysisTA:
    ...
    def calculate_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        try:
            ...
            logger.info(
                "TA-Lib technical indicator calculations completed successfully."
            )
            return df
...
def display_wide_chart(
    df: pd.DataFrame, price_cols: List[str], indicator_cols: List[str]
):
...
def main():
    try:
        cprint(
            "\n=== Starting TA-Lib Technical Analysis ===",
            "white",
            "on_blue",
            attrs=["bold"],
        )
        ...
        cprint(
            "\n=== TA-Lib Technical Analysis Complete ===",
            "white",
            "on_blue",
            attrs=["bold"],
        )
