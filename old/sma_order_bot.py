...
import pandas as pd
import numpy as np
import keyfile as ds  # need to get this set right and my phemex api's
from datetime import date, datetime, timezone, tzinfo
import time, schedule
from scripts.common.config_loader import load_config

phemex = ccxt.phemex(
    {"enableRateLimit": True, "apiKey": ds.xP_hmv_KEY, "secret": ds.xP_hmv_SECRET}
)
    ...
    for ord in closed_orders[-1::-1]:
        ...
        if status == "Filled":
            ...
            if time_spread < sincelasttrade:
                ...
                print(
                    f"the time spead is less than {sincelasttrade} mins its been {time_spread}mins.. so we SLEEPING for 60 secs.."
                )
                time.sleep(60)
